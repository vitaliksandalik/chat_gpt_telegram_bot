message_templates = {
    'en': {
        ...
        'help': 'You can interact with this bot using commands like /language, /image, /audio and /help.',
    ...
    'ua': {
        ...
        'help': 'Ви можете взаємодіяти з цим ботом за допомогою таких команд, як /language, /image, /audio та /help.',
